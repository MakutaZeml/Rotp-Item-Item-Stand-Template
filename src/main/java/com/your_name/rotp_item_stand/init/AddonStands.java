...
public class AddonStands {
    ...
    public static final EntityStandSupplier<EntityStandType<StandStats>, StandEntityType<ItemStandEntity>>
            ITEM_STAND = new EntityStandSupplier<>(InitStands.STAND_ITEM);
}